...
console.log(civilServants, 'civilServants')
</script>
<template>
  <div class="m-[60px]">
    <div class="flex items-center justify-between">
      ...
      <div v-if="timer > 0 && civilServants?.length">
        ...
        >
          ...
          <tbody>
            <tr
              ...
              class="border border-[#DDDDDD] hover:bg-gray-50 text-sm font-normal leading-[18px] text-left text-[#000000] cursor-grab"
              :draggable="true"
  ...
  >
    <div class="bg-white rounded-lg shadow-lg w-[437px] h-[280px]">
      ...
      <!-- Description -->
      <div v-if="!civilServants?.length" class="px-[20px] pt-[20px] h-[150px]">
